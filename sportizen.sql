...
(nextval('seq_complexe'), 'Complexe Pierre Mauroy',     '23 Avenue du Sport, Lille', 1),
(nextval('seq_complexe'), 'Complexe Gerland',           '5 Rue des Lions, Lyon', 1),
(nextval('seq_complexe'), 'Complexe Vélodrome',         '45 Boulevard du Sud, Marseille', 1),
(nextval('seq_complexe'), 'Complexe la Beaujoire',      '78 Rue des Fleurs, Nantes', 1),
(nextval('seq_complexe'), 'Complexe Marcel Picot',      '33 Rue des Sports, Nancy', 1),
(nextval('seq_complexe'), 'Complexe Geoffroy-Guichard', '99 Avenue Verte, Saint-Étienne', 1),
(nextval('seq_complexe'), 'Complexe Bollaert-Delelis',  '27 Rue du Nord, Lens', 1),
(nextval('seq_complexe'), 'Complexe Allianz Riviera',   '40 Chemin des Pins, Nice', 1),
(nextval('seq_complexe'), 'Complexe Océane',            '3 Rue du Havre, Le Havre', 1),
(nextval('seq_complexe'), 'Complexe Auguste Delaune',   '11 Rue du Stade, Reims', 1),
(nextval('seq_complexe'), 'Complexe Gaston Gérard',     '17 Rue des Vignes, Dijon', 1),
(nextval('seq_complexe'), 'Complexe Francis Le Blé',    '8 Rue des Capucins, Brest', 1),
(nextval('seq_complexe'), 'Complexe Matmut Atlantique', '25 Rue Atlantique, Bordeaux', 1),
(nextval('seq_complexe'), 'Complexe Stade de la Source','56 Rue du Parc, Orléans', 1),
(nextval('seq_complexe'), 'Complexe Stade Bonal',       '9 Avenue de la Liberté, Sochaux', 1);
...
-- =================
-- =================
-- CRENEAUX (60)  ✅ corrigé: colonnes debut_ts / fin_ts
-- =================
INSERT INTO creneau (id_creneau, debut_ts, fin_ts) VALUES
(nextval('seq_creneau'), '2025-10-20 10:00:00', '2025-10-20 12:00:00'),
(nextval('seq_creneau'), '2025-10-20 12:00:00', '2025-10-20 14:00:00'),
(nextval('seq_creneau'), '2025-10-20 14:00:00', '2025-10-20 16:00:00'),
(nextval('seq_creneau'), '2025-10-20 16:00:00', '2025-10-20 18:00:00'),
(nextval('seq_creneau'), '2025-10-20 18:00:00', '2025-10-20 20:00:00'),
(nextval('seq_creneau'), '2025-10-22 10:00:00', '2025-10-22 12:00:00'),
(nextval('seq_creneau'), '2025-10-22 12:00:00', '2025-10-22 14:00:00'),
(nextval('seq_creneau'), '2025-10-22 14:00:00', '2025-10-22 16:00:00'),
(nextval('seq_creneau'), '2025-10-22 16:00:00', '2025-10-22 18:00:00'),
(nextval('seq_creneau'), '2025-10-22 18:00:00', '2025-10-22 20:00:00'),
(nextval('seq_creneau'), '2025-10-24 10:00:00', '2025-10-24 12:00:00'),
(nextval('seq_creneau'), '2025-10-24 12:00:00', '2025-10-24 14:00:00'),
(nextval('seq_creneau'), '2025-10-24 14:00:00', '2025-10-24 16:00:00'),
(nextval('seq_creneau'), '2025-10-24 16:00:00', '2025-10-24 18:00:00'),
(nextval('seq_creneau'), '2025-10-24 18:00:00', '2025-10-24 20:00:00'),
(nextval('seq_creneau'), '2025-10-26 10:00:00', '2025-10-26 12:00:00'),
(nextval('seq_creneau'), '2025-10-26 12:00:00', '2025-10-26 14:00:00'),
(nextval('seq_creneau'), '2025-10-26 14:00:00', '2025-10-26 16:00:00'),
(nextval('seq_creneau'), '2025-10-26 16:00:00', '2025-10-26 18:00:00'),
(nextval('seq_creneau'), '2025-10-26 18:00:00', '2025-10-26 20:00:00'),
(nextval('seq_creneau'), '2025-10-28 10:00:00', '2025-10-28 12:00:00'),
(nextval('seq_creneau'), '2025-10-28 12:00:00', '2025-10-28 14:00:00'),
(nextval('seq_creneau'), '2025-10-28 14:00:00', '2025-10-28 16:00:00'),
(nextval('seq_creneau'), '2025-10-28 16:00:00', '2025-10-28 18:00:00'),
(nextval('seq_creneau'), '2025-10-28 18:00:00', '2025-10-28 20:00:00'),
(nextval('seq_creneau'), '2025-10-30 10:00:00', '2025-10-30 12:00:00'),
(nextval('seq_creneau'), '2025-10-30 12:00:00', '2025-10-30 14:00:00'),
(nextval('seq_creneau'), '2025-10-30 14:00:00', '2025-10-30 16:00:00'),
(nextval('seq_creneau'), '2025-10-30 16:00:00', '2025-10-30 18:00:00'),
(nextval('seq_creneau'), '2025-10-30 18:00:00', '2025-10-30 20:00:00'),
(nextval('seq_creneau'), '2025-11-01 10:00:00', '2025-11-01 12:00:00'),
(nextval('seq_creneau'), '2025-11-01 12:00:00', '2025-11-01 14:00:00'),
(nextval('seq_creneau'), '2025-11-01 14:00:00', '2025-11-01 16:00:00'),
(nextval('seq_creneau'), '2025-11-01 16:00:00', '2025-11-01 18:00:00'),
(nextval('seq_creneau'), '2025-11-01 18:00:00', '2025-11-01 20:00:00'),
(nextval('seq_creneau'), '2025-11-03 10:00:00', '2025-11-03 12:00:00'),
(nextval('seq_creneau'), '2025-11-03 12:00:00', '2025-11-03 14:00:00'),
(nextval('seq_creneau'), '2025-11-03 14:00:00', '2025-11-03 16:00:00'),
(nextval('seq_creneau'), '2025-11-03 16:00:00', '2025-11-03 18:00:00'),
(nextval('seq_creneau'), '2025-11-03 18:00:00', '2025-11-03 20:00:00'),
(nextval('seq_creneau'), '2025-11-05 10:00:00', '2025-11-05 12:00:00'),
(nextval('seq_creneau'), '2025-11-05 12:00:00', '2025-11-05 14:00:00'),
(nextval('seq_creneau'), '2025-11-05 14:00:00', '2025-11-05 16:00:00'),
(nextval('seq_creneau'), '2025-11-05 16:00:00', '2025-11-05 18:00:00'),
(nextval('seq_creneau'), '2025-11-05 18:00:00', '2025-11-05 20:00:00'),
(nextval('seq_creneau'), '2025-11-07 10:00:00', '2025-11-07 12:00:00'),
(nextval('seq_creneau'), '2025-11-07 12:00:00', '2025-11-07 14:00:00'),
(nextval('seq_creneau'), '2025-11-07 14:00:00', '2025-11-07 16:00:00'),
(nextval('seq_creneau'), '2025-11-07 16:00:00', '2025-11-07 18:00:00'),
(nextval('seq_creneau'), '2025-11-07 18:00:00', '2025-11-07 20:00:00'),
(nextval('seq_creneau'), '2025-11-09 10:00:00', '2025-11-09 12:00:00'),
(nextval('seq_creneau'), '2025-11-09 12:00:00', '2025-11-09 14:00:00'),
(nextval('seq_creneau'), '2025-11-09 14:00:00', '2025-11-09 16:00:00'),
(nextval('seq_creneau'), '2025-11-09 16:00:00', '2025-11-09 18:00:00'),
(nextval('seq_creneau'), '2025-11-09 18:00:00', '2025-11-09 20:00:00'),
(nextval('seq_creneau'), '2025-11-11 10:00:00', '2025-11-11 12:00:00'),
(nextval('seq_creneau'), '2025-11-11 12:00:00', '2025-11-11 14:00:00'),
(nextval('seq_creneau'), '2025-11-11 14:00:00', '2025-11-11 16:00:00'),
(nextval('seq_creneau'), '2025-11-11 16:00:00', '2025-11-11 18:00:00'),
(nextval('seq_creneau'), '2025-11-11 18:00:00', '2025-11-11 20:00:00');
